...
class medicamentRecipe extends Model
{
    ...
    {
        $medicamentRecipe = new medicamentRecipe($medicamentId, $recipeId, $pdo);
        $medicamentRecipe->queries[] = "INSERT medicamentRecipe(medicamentId, recipeId) VALUES ('$medicamentId', '$recipeId')";
        return $medicamentRecipe;
    }
